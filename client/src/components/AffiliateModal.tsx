      ...
      <DialogContent className="bg-[#0F0F18] border border-amber-500/20 text-white max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="text-center text-gray-400">
            {success
              ? "Váš affiliate účet byl vytvořen."
              : "Vydělávejte až 77% opakovanou provizi z každého přivedeného zákazníka."}
          </DialogDescription>
        </DialogHeader>
        ...
        {!success ? (
          <form onSubmit={handleSubmit} className="space-y-4 mt-4">
            ...
            <div className="grid grid-cols-2 gap-2 mb-2">
              <div className="bg-amber-500/5 border border-amber-500/10 rounded-lg p-3 text-center">
                ...
                <div className="text-xs text-gray-500">opakovaná provize</div>
              </div>
              <div className="bg-amber-500/5 border border-amber-500/10 rounded-lg p-3 text-center">
                <div className="text-lg font-bold text-amber-400 font-[Space_Grotesk]">156 816 Kč</div>
                <div className="text-xs text-gray-500">roční potenciál</div>
              </div>
            </div>
            ...
            <Input
              type="url"
              placeholder="Web / Blog URL (volitelné)"
              value={website}
            ...
            <div className="flex items-start gap-3">
              ...
              <label htmlFor="gdpr-aff" className="text-xs text-gray-400 leading-relaxed">
                Souhlasím se zpracováním osobních údajů a s podmínkami affiliate programu BOTHUB.cz.
              </label>
            </div>
          ...
          <div className="space-y-6 mt-4">
            ...
            <div className="bg-amber-500/5 border border-amber-500/20 rounded-xl p-6 text-center">
              <p className="text-xs text-gray-400 mb-2 uppercase tracking-wider">Váš affiliate kód</p>
              <div className="flex items-center justify-center gap-3">
                <span className="font-[Space_Grotesk] text-3xl font-black text-amber-400">
                  {affiliateCode}
                </span>
                <button
            ...
            <div className="bg-white/[0.02] border border-white/5 rounded-lg p-4">
              <p className="text-xs text-gray-400 mb-2">Váš referral odkaz:</p>
              <code className="text-xs text-amber-400/80 break-all">
                {typeof window !== "undefined"
                  ? `${window.location.origin}?ref=${affiliateCode}`
                  : `https://bothub.cz?ref=${affiliateCode}`}
              </code>
            </div>

            <div className="text-sm text-gray-400 space-y-2">
              <p>Na váš e-mail jsme odeslali potvrzení s dalšími instrukcemi.</p>
              <p className="text-amber-400/80">Sdílejte svůj odkaz a začněte vydělávat!</p>
            </div>
