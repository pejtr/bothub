...
export function LiveChatDemo() {
  ...
  const chatMutation = trpc.chat.send.useMutation({
    ...
    onError: () => {
      setMessages((prev) => [
        ...prev,
        { role: "assistant", content: "Omlouvám se, zkuste to prosím znovu." },
      ]);
    },
  });
  ...
  const suggestedPrompts = [
    "Jak iBoti zvyšují prodeje?",
    "Kolik stojí GOLD plán?",
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-white/5 bg-gradient-to-r from-amber-500/10 to-purple-500/10">
              ...
              <button
                ...
                className="w-8 h-8 rounded-lg hover:bg-white/5 flex items-center justify-center transition-colors text-gray-400 hover:text-white"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
              ...
              {displayMessages.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full gap-4">
                  ...
                  <div className="text-center">
                    <p className="text-sm font-medium text-white mb-1">Vyzkoušejte iBota v akci!</p>
                    <p className="text-xs text-gray-500">Zeptejte se na cokoli o BOTHUB</p>
                  </div>
            ...
            <div className="border-t border-white/5 p-3 bg-[#0A0A0F]">
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  size="icon"
                  className="shrink-0 w-10 h-10 rounded-xl bg-amber-500 hover:bg-amber-600 text-black disabled:opacity-30"
                >
                  {chatMutation.isPending ? (
              ...
              <p className="text-[10px] text-gray-600 mt-2 text-center">
                Toto je ukázka Alex Hormozi iBota. Plná verze dostupná po registraci.
              </p>
            </div>
          </motion.div>
        )}
