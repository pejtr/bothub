...
const testimonials = [
  ...
  },
  {
    ...
    avatar: "JN",
    rating: 5,
    textCs: "Díky affiliate programu BOTHUB vydělávám pasivně přes 30 000 Kč měsíčně. Stačilo doporučit iBoty svým klientům. 77% provize z každé platby je neskutečný deal.",
    textEn: "Thanks to the BOTHUB affiliate program, I passively earn over $1,200/month. All I had to do was recommend iBots to my clients. 77% commission on every payment is an incredible deal.",
