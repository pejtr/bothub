...
const videoDemos: VideoDemo[] = [
  ...
  },
  {
    ...
    descCs: "Jak affiliate partner generuje pasivní příjem sdílením iBotů. Reálný příklad: 30 000+ Kč/měsíc s 77% provizí.",
    descEn: "How an affiliate partner generates passive income sharing iBots. Real example: $1,200+/month with 77% commission.",
    catCs: "Affiliate program",
    catEn: "Affiliate Program",
    icon: <Users className="w-5 h-5" />,
    duration: "4:05",
    statsCs: "77 % provize",
    statsEn: "77% commission",
    color: "emerald",
  },
];
