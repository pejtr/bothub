...
const translations: Record<Locale, TranslationDict> = {
  cs: {
    ...
    // Hero
    "hero.badge": "77 AI osobností ve 7 kategoriích",
    ...
    "ps.row4.ibot": "77 unikátních osobností",
    "ps.row5.feature": "ROI",
    ...
    "catalog.title1": "77 AI osobností. ",
    ...
    "catalog.unlock.title": "Odemkněte všech 77 iBotů",
    ...
    "pricing.diamond.f1": "Všech 77 iBotů",
    ...
    "pricing.diamond.f6": "Affiliate 77% provize",
    ...
    "affiliate.benefit1.title": "Až 77 % provize",
    "affiliate.benefit1.desc": "Nejvyšší provize v oboru. GOLD: 66%, DIAMOND: 77% z každé platby.",
    ...
    // Footer
    "footer.desc": "AI chatboti, kteří prodávají za vás. 77 unikátních osobností ve 7 kategoriích.",
  ...
  en: {
    ...
    // Hero
    "hero.badge": "77 AI Personalities in 7 Categories",
    ...
    "ps.row4.ibot": "77 unique personalities",
    "ps.row5.feature": "ROI",
    ...
    "catalog.title1": "77 AI Personalities. ",
    ...
    "catalog.unlock.title": "Unlock all 77 iBots",
    ...
    "pricing.diamond.f1": "All 77 iBots",
    ...
    "pricing.diamond.f6": "Affiliate 77% commission",
    ...
    "affiliate.benefit1.title": "Up to 77% commission",
    "affiliate.benefit1.desc": "Highest commissions in the industry. GOLD: 66%, DIAMOND: 77% of every payment.",
    ...
    // Footer
    "footer.desc": "AI chatbots that sell for you. 77 unique personalities in 7 categories.",
